...
import 'package:stsexam/controller/announcements/announcements_controller.dart';
...
class AnnouncementsScreen extends StatefulWidget {
  @override
  State<AnnouncementsScreen> createState() => _NotificationPageState();
}

class _NotificationPageState extends State<AnnouncementsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels >=
        ...
        controller.loadMoreAnnouncements(context: context);
      }
    });
    return Scaffold(
      appBar: AppBar(
      ...
      body: RefreshIndicator(
        onRefresh: () => controller.refreshAnnouncementsList(context: context),
        child: Obx(() {
          ...
          return ListView.builder(
            ...
            itemCount:
                controller.announcementsList.isEmpty
                    ? 1
            ...
            itemBuilder: (context, int index) {
              ...
              if (index == controller.announcementsList.length) {
              ...
              var noti = controller.announcementsList[index];
              return Column(
                children: [
                  ListTile(
                    leading: Container(
