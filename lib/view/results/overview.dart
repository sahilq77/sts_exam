      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            color: const Color(0xFFE5E7EB), // Border color #E5E7EB
          ),
        ),
      ),
      body: Padding(
        ...
        child: RefreshIndicator(
            onRefresh: () => controller.refreshOverview(
                context: context), // Called when user pulls down to refresh
                    ...
                    decoration: BoxDecoration(
                      color: isSelected
                          ? (isCorrect
                              ...
                              : const Color(0xFFFDC2626).withOpacity(0.2))
                          : Colors.white,
