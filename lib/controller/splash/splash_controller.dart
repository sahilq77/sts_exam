...
class SplashController extends GetxController {
  ...
  Future<void> _checkLoginStatus() async {
    ...
    // Request camera and notification permissions only
    ...
    if ((cameraDenied || cameraPermanentlyDenied) ||
      ...
      Get.snackbar(
        ...
        mainButton: TextButton(
          onPressed: () async {
            if (cameraPermanentlyDenied || notificationPermanentlyDenied) {
          ...
          child: Text(
            cameraPermanentlyDenied || notificationPermanentlyDenied
                ? 'Open Settings'
                : 'Retry',
